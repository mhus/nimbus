...
class QuadrantAuthorizationIT {
    ...
    @Test
    void user_cannot_create_quadrant() {
        HttpHeaders h = bearer(userToken);
        String body = "{\"name\":\"q1\",\"apiUrl\":\"http://api/q1\",\"publicSignKey\":\"key\",\"maintainers\":\"maint\"}";
        ResponseEntity<String> resp = restTemplate.postForEntity("/universe/quadrant", new HttpEntity<>(body,h), String.class);
    ...
    void maintainer_must_include_self_in_maintainers_for_create() {
        ...
        ResponseEntity<String> resp1 = restTemplate.postForEntity("/universe/quadrant", new HttpEntity<>(bodyMissingSelf,h), String.class);
        ...
        ResponseEntity<QuadrantControllerResponse> resp2 = restTemplate.postForEntity("/universe/quadrant", new HttpEntity<>(bodyOk,h), QuadrantControllerResponse.class);
    ...
    void maintainer_not_listed_cannot_update() {
        // Admin erstellt Quadrant ohne maintainer
        HttpHeaders ha = bearer(adminToken);
        String body = "{\"name\":\"q4\",\"apiUrl\":\"http://api/q4\",\"publicSignKey\":\"k\",\"maintainers\":\"admin\"}";
        ResponseEntity<QuadrantControllerResponse> create = restTemplate.postForEntity("/universe/quadrant", new HttpEntity<>(body, ha), QuadrantControllerResponse.class);
        ...
        ResponseEntity<QuadrantControllerResponse> update = restTemplate.exchange("/universe/quadrant/"+id, HttpMethod.PUT, new HttpEntity<>(upd, hm), QuadrantControllerResponse.class);
    ...
    void admin_can_delete() {
        ...
        ResponseEntity<QuadrantControllerResponse> create = restTemplate.postForEntity("/universe/quadrant", new HttpEntity<>(body, ha), QuadrantControllerResponse.class);
        String id = create.getBody().id();
        ResponseEntity<Void> del = restTemplate.exchange("/universe/quadrant/"+id, HttpMethod.DELETE, new HttpEntity<>(ha), Void.class);
    ...
    public record QuadrantControllerResponse(String id, String name, String apiUrl, String publicSignKey, java.util.List<String> maintainers) {}
}
