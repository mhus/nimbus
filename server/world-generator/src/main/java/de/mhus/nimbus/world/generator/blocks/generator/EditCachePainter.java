...
public class EditCachePainter {
     ...
     */
    public void domeOutline(WWorld world, String layerDataId, String modelName, int x, int y, int z, int radius, BlockDef blockDef) {
        if (radius < 1) return;
        int r2 = radius * radius;
        for (int dx = -radius; dx <= radius; dx++) {
     ...
     */
    public void pyramidOutline(WWorld world, String layerDataId, String modelName, int x, int y, int z, int size, int height, BlockDef blockDef) {
     ...
     */
    public void cylinderOutline(WWorld world, String layerDataId, String modelName, int x, int y, int z, int radius, int height, BlockDef blockDef) {
     ...
     */
    public void coneOutline(WWorld world, String layerDataId, String modelName, int x, int y, int z, int radius, int height, BlockDef blockDef) {
        if (radius < 1 || height < 1) return;
        int steps = Math.max(12, (int) (2 * Math.PI * radius));
        int topY = y + height;
    ...
    public static class BlockPainter {
        public void paint(EditCachePainter painter,  int x, int y, int z) {
            ...
            painter.editService.setAndSendBlock(painter.world, painter.layerDataId, painter.modelName, block, painter.groupId);
        }
    }
