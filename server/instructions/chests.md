...
[x] Erstelle eine WChest und WChestRepository und WChestService in world-shared
WChest
...
[x] Erstelle eine WChestController in world-api zum verwalten von WChests in world-control
- Abfrage fuer user related chests
- Abfrage fuer region related chests
- Abfrage fuer world related chests

[x] Unter client/packages/shared/src/generated/entities/WChest.ts ist nun die TypeScript entity.
...
[x] Es gibt jetzt ein client/packages/shared/src/generated/entities/WItem.ts TypeScript Entity.
...
[x] Der chest-editor muss neu gemacht werden. Da wir referenzen auf Items haben muessen auch items geladen werden (EItemController).
...
[x] Erstelle in HomeApp.vue einen Eintrag fuer den neuen chest-editor Editor

[x] wenn type world, dann existierende welten in dieser region auswahl, wenn type user, dann user auswahl
