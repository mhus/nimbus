...
/**
 * Basis-Klasse für REST API System-Tests.
 * Nutzt WebSocket Login um sessionId zu erhalten, dann HTTP Calls.
 */
public abstract class AbstractRestTest extends AbstractSystemTest {
