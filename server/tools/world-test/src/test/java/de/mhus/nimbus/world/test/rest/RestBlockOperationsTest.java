...
/**
 * REST API System-Tests für Block Operations Endpoints.
 * Testet alle GET Endpoints für Block-Verwaltung.
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@DisplayName("REST Block Operations API Tests")
class RestBlockOperationsTest extends AbstractRestTest {
