/**
 * Glass Renderer
 * Renders GLASS shaped blocks (transparent cubes)
 *
 * Glass blocks are rendered as full cubes with all 6 faces.
 * The transparency and visibility from both sides is handled by the material settings
 * (backFaceCulling = false), so we don't need to render faces twice.
 */

import { ShapeRenderer } from './ShapeRenderer';
import type { BlockRenderContext } from './BlockRenderContext';

export class GlassRenderer extends ShapeRenderer {
