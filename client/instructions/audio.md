...
- Der sound wid im ChunkService gestartet, wenn der Chunk erstellt wird und gestoppt wenn der Chunk entladen wird.
- Dafuer wird eine Referenz im ClientChunkDate 'resourcesToDispose' vermerkt. 
- Erweitere den Typ AudioDefinition um den Type 'permanent'.
- Erweitere den Editor (AudioEditor) um den Type 'permanent'.
- Es wird nur eine permanente (und enabled) audio datei pro block unterstuetzt. Im Editor keonnen aber mehrere hinzugefuegt 
